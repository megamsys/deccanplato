 ...
 * @author pandiyaraja
 * 
 *This class is used to perform Potential business activity for ZOHO business activities
 * create, list, update and delete. And this class
 *uses a business support classes(Potentials) to populate ZOHO XML input data.
 */
public class PotentialImpl implements BusinessActivity{

	private static final String ZOHO_CRM_POTENTIAL_XML_URL="https://crm.zoho.com/crm/private/xml/Potentials/";
	private static final String ZOHO_CRM_POTENTIAL_JSON_URL="https://crm.zoho.com/crm/private/json/Potentials/";
	...
	/**
	 * this method lists all Potential in zoho.com and returns a list of json Potential details.
	 * This method takes input as a MAP(contains json dada) and returns a MAP.
	 * @param outMap 
	 */
	private Map<String, String> list(Map<String, String> outMap) {
        ...
        TransportTools tst = new TransportTools(ZOHO_CRM_POTENTIAL_JSON_URL+GET_RECORDS, potentialAttrList, null, true, "UTF-8");
		String responseBody = null;
	...
	/**
	 * this method delete a particular Potential in zoho.com and returns success message with deleted Potential id.
	 * This method takes input as a MAP(contains json dada) and returns a MAP.
	 * @param outMap 
	 */
	private Map<String, String> delete(Map<String, String> outMap) {
		...
		TransportTools tst = new TransportTools(ZOHO_CRM_POTENTIAL_JSON_URL+DELETE_RECORDS, potentialAttrList);
		String responseBody = null;
