...
public class NormalizeEndpointImpl implements BusinessActivity{
	...
	public Map<String, String> run() {
		...
		final String NORMALIZE_URL="http://napi.maluuba.com/v0/normalize?"+PHRASE+"="+args.get(PHRASE)+"&"+TYPE+"="+args.get(TYPE)+"&"+APIKEY+"="+args.get(APIKEY)+"&"+TIMEZONE+"="+args.get(TIMEZONE);
		
		TransportTools tst = new TransportTools(NORMALIZE_URL, null,
				null);
