 ...
 * 
 */
public class ChatterAnswersActivityImpl implements BusinessActivity {

	private static final String SALESFORCE_CHATTER_ANSWER_ACTIVITY_URL = "/services/data/v25.0/query/?q=SELECT+UserId,BestAnswerReceivedCount,BestAnswerSelectedCount,QuestionsCount,RepliesCount,ReplyUpVotesCount+FROM+ChatterAnswersActivity";
