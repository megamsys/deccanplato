 ...
 *
 */
public class ChatterConversationImpl implements BusinessActivity{

	private static final String SALESFORCE_CHATTER_CONVERSATION_URL = "/services/data/v25.0/query/?q=SELECT+Id+FROM+ChatterConversation";
