 ...
 * @author pandiyaraja
 *
 *This Record Feed class implements salesforce chatter record feed items
 *this class shows record feed url and record feed item
 */
public class RecordFeedImpl implements BusinessActivity{
	 ...
	 * @param outMap(User id)
	 * @return
	 */
	private Map<String, String> view(Map<String, String> outMap) {
		
		final String SALESFORCE_CHATTER_ACTIVITY_URL = "/services/data/v26.0/chatter/records/"+args.get(ID)+"/followers";
