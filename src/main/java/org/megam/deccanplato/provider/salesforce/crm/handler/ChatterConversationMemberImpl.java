 ...
 *
 */
public class ChatterConversationMemberImpl implements BusinessActivity{

	private static final String SALESFORCE_CHATTER_CONVERSATION_URL = "/services/data/v25.0/query/?q=SELECT+ConversationId,MemberId+FROM+ChatterConversationMember";
	...
	public String name() {
		...
		return "chatterconversationmember";
	}
}
