 ...
 * 
 */
public class ChatterMessageImpl implements BusinessActivity {

	private static final String SALESFORCECRM_CHATTER_MESSAGE_URL = "/services/data/v25.0/sobjects/ChatterMessage/";
	private static final String SALESFORCE_CHATTER_MESSAGE_LIST_URL = "/services/data/v25.0/query/?q=SELECT+Body,ConversationId,SenderId,SentDate+FROM+ChatterMessage";
	...
	private Map<String, String> delete(Map<String, String> outMap) {
		...
		TransportTools tst = new TransportTools(args.get(INSTANCE_URL)
				+ SALESFORCECRM_CHATTER_MESSAGE_URL + args.get(ID), null,
				header);
	...
	private Map<String, String> list(Map<String, String> outMap) {
		...
		TransportTools tst = new TransportTools(args.get(INSTANCE_URL)
				+ SALESFORCE_CHATTER_MESSAGE_LIST_URL, null, header);
		String responseBody = null;
