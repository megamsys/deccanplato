...
/**
 * This class implements the business activity of Salesforcecrm task method.
 * this class has four methods, to implement business functions, like create, update,
 * lisd and delete. 
 * 
 * @author pandiyaraja
 */
public class TaskImpl implements BusinessActivity{
	private static final String SALESFORCE_TASK_URL="/services/data/v25.0/sobjects/Task/";	
...
final String SALESFORCE_CREATE_PRODUCT_URL = args.get(INSTANCE_URL)+SALESFORCE_TASK_URL;
    ...
    userAttrMap.put("Priority", args.get(PRIORITY));
...
private Map<String, String> delete(Map<String, String> outMap) {
	final String SALESFORCE_DELETE_PRODUCT_URL = args.get(INSTANCE_URL)
			+ SALESFORCE_TASK_URL+args.get(ID);
	Map<String, String> header = new HashMap<String, String>();
	header.put(S_AUTHORIZATION, S_OAUTH+ args.get(ACCESS_TOKEN));
