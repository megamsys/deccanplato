 ...
 * @author pandiyaraja
 *
 *This class implements salesforce chatter influencethresholds and 
 *shows details about influencethreshold details.
 */
public class InfluenceThresholdsImpl implements BusinessActivity{

	private static final String SALESFORCE_CHATTER_CONVERSATION_URL = "/services/data/v25.0/chatter/influence/thresholds";
