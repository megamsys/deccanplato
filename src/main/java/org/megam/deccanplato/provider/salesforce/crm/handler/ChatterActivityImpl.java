 ...
 * 
 */
public class ChatterActivityImpl implements BusinessActivity {

	private static final String SALESFORCE_CHATTER_ACTIVITY_URL = "/services/data/v25.0/query/?q=SELECT+ParentId,PostCount,LikeReceivedCount,CommentReceivedCount,CommentCount+FROM+ChatterActivity";
